...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2024/09/05 22:29:31 by zel-oirg          #+#    #+#             */
/*   Updated: 2024/09/05 22:31:15 by zel-oirg         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	check_var(char *var, char *fct, t_envi **envi)
{
	...
	if (!ft_isalpha(var[i]) && var[i] != '_')
	{
		...
		return (ft_putstr_fd("minishell: ", 2), ft_putstr_fd(fct, 2)
			, ft_putstr_fd(": `", 2), ft_putstr_fd(var, 2)
